...
class Rover {
  ...
  void update(int xvel, int yvel, int armVel, int brushAccel, int door) {
    //x and y velocity can be sent straight to the arduino for PWM, armVel should be converted to a position
    //BrushAccel can be sent to the arduino for conversion to speed for PWM, door should only be sent when it is toggled.
